      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto bg-accentGreen/5 rounded-[60px] p-12 md:p-20 border border-accentGreen/5">
          ...
          <div className="grid md:grid-cols-2 gap-12">
             <div className="space-y-6 text-lg text-textDark/70 leading-relaxed">
               <p>Wissenschaftliche Erkenntnisse zeigen, dass ambulante psychiatrische Pflege einen wichtigen Beitrag zur Stabilisierung im Alltag leistet.</p>
               <p>Gerade in Übergangsphasen, etwa nach einem Klinikaufenthalt, bietet ambulante Pflege eine tragfähige Brücke zurück in den Alltag.</p>
             </div>
             <ul className="space-y-4">
               {[
                 "Krisen frühzeitig abfedern",
                 "stationäre Aufenthalte vermeiden/verkürzen",
                 "Selbstständigkeit & Lebensqualität erhalten",
                 "Angehörige entlasten",
                 "Kontinuität in der Versorgung sichern"
               ].map((text, i) => (
                 <li key={i} className="flex gap-3 font-bold text-accentGreen uppercase tracking-wider text-xs border-b border-accentGreen/10 pb-4">
                    <span className="text-accentBrown">0{i+1}</span>
                    {text}
                 </li>
               ))}
             </ul>
