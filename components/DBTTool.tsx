...
const DBTTool: React.FC = () => {
                ...
                {!showSecondary && (
                  <button 
                    onClick={() => {
                      ...
                      // UX: Gezielter Scroll-Nudge beim Aufklappen der Liste
                      setTimeout(() => {
  ...
  return <div ref={scrollRef} className="h-full flex flex-col font-sans overflow-hidden custom-scrollbar">{renderView()}</div>;
};
