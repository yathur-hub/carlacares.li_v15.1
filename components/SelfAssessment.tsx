...
const SelfAssessment: React.FC = () => {
  ...
  return (
    <div ref={scrollRef} className="bg-white rounded-[40px] shadow-2xl border border-gray-100 overflow-y-auto overflow-x-hidden min-h-[620px] flex flex-col relative custom-scrollbar">
