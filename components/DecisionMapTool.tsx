...
const DecisionMapTool: React.FC = () => {
  ...
  return (
    <div ref={scrollRef} className="bg-white rounded-[40px] shadow-2xl border border-gray-100 overflow-y-auto overflow-x-hidden flex flex-col h-full min-h-[500px] custom-scrollbar">
